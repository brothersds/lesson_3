...
def my_func(name, surname, year_birth, current_city, user_email, phone_number):
    ...
    year_birth - {year_birth}; current_city - {current_city};\
    user_email - {user_email}; phone_number - {phone_number}")


my_func(name='Ivan', surname='Petrov', year_birth=1956, current_city='Moscow', user_email='petrov@mail.ru',
        phone_number=2113636)
